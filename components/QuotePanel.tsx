            ...
            <>
              ...
              <form onSubmit={submit} noValidate className="mt-7 grid gap-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="mt-2 inline-flex items-center justify-center gap-2 bg-brand px-7 py-4 text-[16px] font-semibold text-ink transition-[filter] duration-200 hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {submitting ? "Sending…" : "Send my enquiry"}
                </button>
                {submitError && (
                  <p className="text-center text-[13px] text-red-400/90">
                    {submitError}
                  </p>
                )}
